        ...
        <div className="space-y-6">
            {settings.stats && (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <StatCard icon="fa-door-open" title={t('dashboard.manager.availableRooms')} value={data.stats.availableRooms} color="bg-green-500" onClick={() => navigate('/housing')} />
                    <StatCard icon="fa-wrench" title={t('dashboard.manager.openTickets')} value={data.stats.openMaintenance} color="bg-yellow-500" onClick={() => navigate('/maintenance')} />
                    <StatCard icon="fa-file-contract" title={t('dashboard.manager.expiringContracts')} value={data.stats.expiringContracts.length} color="bg-red-500" onClick={() => navigate('/employees')} />
